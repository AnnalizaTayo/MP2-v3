      ...
      {/*
        ...
        return (
          <div className="pagination-buttons">
            <button onClick={goToPreviousPage} disabled={currentPage === 1} className={(currentPage === 1 ? 'hide': '')}>
              Previous
            </button>
            {/*renderPageButtons()*/}
            <input type="number" value={currentPage} onChange={handleChangePage} min="1" max={totalPages} />&nbsp;&nbsp;/&nbsp;{totalPages}
            <button onClick={goToNextPage} disabled={currentPage === totalPages} className={(currentPage === totalPages) ? 'hide' : ''}>
              Next
            </button>
                ...
                <aside>
                    ...
                    <div className='filter-collapse'>
                        ...
                        <div>{/* All Categories */}
                            ...
                            <label>
                                <input className='hide' type="checkbox"checked={isAllSubcategoriesFiltered} onChange={(e)=>{
                                    setIsAllSubcategoriesFiltered(!isAllSubcategoriesFiltered);
                                    handleFilterChange('subcategory', 'All');
                                }} />
                                <p className='hide'>All Subcategories</p>
